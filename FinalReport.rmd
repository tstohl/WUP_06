...
The code that was used for these tests were modifies to include all comparisons possible to make determining differences more accurate. 
fisherXY(x,y confL = 0, printAll = FALSE) was used to create the results.
...
All in all it was determined that The Black category was vastly different from the Other category and the White category. The white and other category did not seem to be